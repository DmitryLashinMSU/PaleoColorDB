...
\restrict DUWQXO5IEZNfuswpKutFBehzSsMn33TDOeSL15XyGU7tBwwAlSu6eC7zzH7sNkR
...
96	Changzuiornis/Changzuiornis_r.png	reconstruction	Художественная реконструкция Changzuiornis ahgmi (цвет изменен, оригинал: https://a-dinosaur-a-day.com/post/168793250520/changzuiornis-ahgmi).
126	Trilobites/Trilobites_r.png	reconstruction	Реконструкция внешнего вида трилобита Eldredgeops с пятнистым узором на панцире. Иллюстрация с сайта https://www.emilydamstra.com/portfolio/devonian-trilobite/.
...
131	Trilobites/Trilobites_f3.png	fossil_photo	Фотография экземпляра Ilaenus из Санкт-Петербурга с темными радиальными полосами на пигидии.
...
135	Cephalopods/Cephalopods_f1.png	fossil_photo	Фот раковины Orthoceras anguliferum (девон, Германия).
...
1	Anchiornis huxleyi	Поздняя юра (оксфордский ярус, ~160 млн лет назад)	Провинция Ляонин, Китай	Формация Тяоцзишань	В работе Li et al., 2010 изучено 29 участков экземпляра BMNHC PH828, по которым путем анализа меланосом восстановлена окраска животного, кроме хвоста и неоперенных частей тела. В Lindgren et al., 2015 исследователи не обнаружили эумеланин, отвечающий за рыжую окраску, в хохолке Anchiornis huxleyi экземпляра YFGP-T5199. При этом авторы отмечают, что из-за разницы в размерах и небольших анатомических отличиях этот образец может представлять другую возрастную стадию, свидетельствовать о половом диморфизме или даже принадлежать к другому, но близкородственному виду оперенных динозавров.	Сканирующая электронная микроскопия (СЭМ) для изучения формы и плотности меланосом и их сравнение с меланосомами современных птиц. Масс-спектрометрия для анализа молекулярного состава.
10	Yi qi	Средняя–поздняя юра (~160 млн лет назад)	Провинция Хэбэй, Китай	Формация Тяоцзишань	Yi qi впервые описан в публикации Xu et al. (2015) по образцу STM 31-2. Для исследования меланосом в перьях взяты пробы с головы, шеи, плеча, локтя и голени. Установлено, что разные участки тела имели разное сочетание меланосом, что говорит о сложной цветовой мозаике. В образцах перепончатой ткани (между пальцами и палочковидной костью) также обнаружены феомеланосомы, но они менее плотно упакованы, чем в перьях. Это означает, что перепонки тоже были пигментированы, но, возможно, светлее или с иным рисунком. Всего исследованы 12 проб из разных частей тела: перья над черепом, перья на шее, перья вдоль плечевой кости, перья вдоль локтевой кости, перья вдоль голени, перепончатая ткань рядом с пальцем II, перепончатая ткань рядом с пальцем IV.	Сканирующая электронная микроскопия (СЭМ).
12	Diplodocus sp. (детеныш)	Поздняя юра (титонский ярус, ~150–145 млн лет назад)	США (штат Монтана)	Формация Моррисон, карьер Mother's Day	В исследовании Gallagher et al., 2025 изучены экземпляры CMC VP 20857, CMC VP 20858, CMC VP 15915, CMC VP 10660, VP 10662 и VP 10659, принадлежащие детенышу диплодока. Соответствие этих фрагментов конкретным участкам тела не установлено. В чешуе обнаружены микротельца продолговатой формы, интерпретируемые как меланосомы. Их размеры попадают в диапазон размеров бурых (феомеланиновых) меланосом современных птиц, а также меланосом черного каймана — единственного нептичьего архозавра с близкими размерами. Разнообразие этих структур указывает на то, что кожа диплодока могла иметь сложный цветовой паттерн. Вероятно, молодые особи диплодока были пятнистыми или пестрыми. Однако, из-за возможного изменения формы ископаемых меланосом со временем, точные цвета узора неизвестны.	Сканирующая электронная микроскопия (СЭМ).
13	Yuanchuavis kompsosoura	Ранний мел (аптский ярус, ~120 млн лет назад)	Провинция Ляонин, Китай	Формация Цзюфотан, биота Джехол	В Wang et al. (2021) изучены меланосомы в хвостовых перьях образца IVPP V27883. Хвост птицы имел контрастную окраску. Два центральных пера были очень темными (черными или темно-коричневыми). Оперение короткого веера у основания хвоста было более светлым — серым, либо имело непереливающийся структурный цвет. В природе такой тип структурного цвета обычно выглядит как насыщенный синий или голубой. Другие участки тела не исследовались с точки зрения окраски.	Сканирующая электронная микроскопия (СЭМ).
17	Wiwaxia corrugata	Средний кембрий (~508 млн лет назад)	Канада (Британская Колумбия)	Сланцы Берджес	В работе Parker (1998) исследовано несколько образцов Wiwaxia corrugata. На поверхности склеритов были выявлены параллельные микроскопические бороздки, физика которых идентична дифракционным решеткам, создающим перелив у современных морских червей.	Электронная микроскопия.
18	Canadia spinosa	Средний кембрий (~508 млн лет назад)	Канада (Британская Колумбия)	Сланцы Берджес	На щетинках образца USNM 202335, принадлежащего полихетному червю Canadia spinosa, обнаружены параллельные бороздки с постоянным периодом, образующие дифракционную решетку, что придавало животному переливающуюся окраску. Такое же устройство имеют щетинки у морской мыши - современного представителя полихет.	Электронная микроскопия.
19	Marrella splendens	Средний кембрий (~508 млн лет назад)	Канада (Британская Колумбия)	Сланцы Берджес	Электронная микроскопия образца AM F38262 выявила наличие параллельных микроскопических бороздок на наружных выростах головного щита Marrella splendens, что придавало им переливающуюся окраску из-за дифракции света.	Электронная микроскопия.
15	Stenopterygius sp.	Ранняя юра (~180 млн лет назад)	Германия (Баден-Вюртемберг)	Посидониевые сланцы	Окраска ихтиозавров исследовалась несколько раз. Сначала в Lindgren et al. (2014) был изучен хвост образца YORYM 1993.338, принадлежащего неопределенному ихтиозавру. На основании исследования этого образца и других ископаемых с полным контуром тела, авторы делают вывод, что ихтиозавры были равномерно темно-окрашенными. Но в последующей публикации Lindgren et al. (2018) произведено более подробное исследование экземпляра MH 432 ихтиозавра Stenopterygius sp. из Германии. Распределение пигментации указывает на то, что животное, вероятно, имело маскировочную противотеневую окраску (темный верх, светлый низ). Кроме того, у ихтиозавра были обнаружены разветвленные меланофоры, которые у современных рептилий способны к физиологическому изменению цвета (перераспределению пигмента).	Комплексный молекулярный и клеточный анализ (включая СЭМ, SRXTM, SRS-XRF, ToF-SIMS и др.).
...
37	Saurolophus angustirostris	Поздний мел (маастрихтский ярус, ~70 млн лет назад)	Монголия (пустыня Гоби)	Формация Немегт	На хвосте динозавра обнаружено чередование зон разной чешуи, откуда делается вывод, что он, вероятнее всего, имел вертикальную полосатую окраску. Обосновывается это тем, что у современных рептилий смена цвета часто, хотя и не всегда, сопровождается сменой типа, размера или текстуры чешуи.	Анализ морфологии ископаемой чешуи.
38	Saurolophus osborni	Поздний мел (маастрихтский ярус, ~70 млн лет назад)	Канада (провинция Альберта)	Формация каньона Хорсшу	На ископаемой коже хвоста динозавра разные по размеру чешуйки группируются в хаотичные мозаичные узоры. Предполагается, что окраска этого вида была крапчатой или пятнистой. Обосновывается это тем, что у современных рептилий смена цвета часто, хотя и не всегда, сопровождается сменой типа, размера или текстуры чешуи.	Анализ морфологии ископаемой чешуи.
...
SELECT pg_catalog.setval('public.media_id_seq', 198, true);
...
SELECT pg_catalog.setval('public.publication_id_seq', 63, true);
...
\unrestrict DUWQXO5IEZNfuswpKutFBehzSsMn33TDOeSL15XyGU7tBwwAlSu6eC7zzH7sNkR
