...
Данные можно редактировать и пополнять. Также доступна упрощенная версия справочника (без возможности редактирования), которая не требует установки каких-либо программ. Достаточно скачать архив по [ссылке](https://drive.google.com/uc?export=download&id=1qjuVnyshb8qGKxh_tBTAn9rckMUeeDd9&confirm=t) и открыть файл `init.html`.
