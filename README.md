...
База содержит представителей каждого периода от кембрийского до мелового. Их окраска изучалась множеством методов: от наиболее известного анализа меланосом (внутриклеточных структур, содержащих пигмент, по форме которых можно определить цвет) оперенных динозавров до прямого наблюдения прижизненных цветов птиц из бирманского янтаря, анализа дифракционных решеток на щетинках кембрийских полихет или предсказания цветовых паттернов по морфологии чешуи мумий эдмонтозавров из США.
...
Запустите скрипт, который загрузит архив с Google Диска и распакует в нужную директорию:
...
Или вручную скачайте его с [Диска](https://drive.google.com/uc?id=16btYr1bv0-ZNAn47-5iBESweTR1LCv77) и распакуйте в `app/static/`.
...
**4. Использование**
*   После запуска контейнера откройте браузер по адресу: [http://localhost:8000](http://localhost:8000)
...
Вы можете подробнее почитать о базе в [статье](https://habr.com/ru/articles/1076912/) на Хабре.