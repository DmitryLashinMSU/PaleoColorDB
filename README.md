...
Данные можно редактировать и пополнять. Также есть упрощенная версия справочника (без возможности редактирования), которая доступна по [ссылке](https://DmitryLashinMSU.github.io/PaleoColor_static/).
